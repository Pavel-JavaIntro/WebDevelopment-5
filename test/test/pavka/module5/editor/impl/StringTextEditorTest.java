...
import by.pavka.module5.editor.impl.StringTextEditorImpl;
...
public class StringTextEditorTest {
  ...
  private TextEditor textEditor = new StringTextEditorImpl(textLoader);
  ...
  public void replaceCharacterTest() {
    ...
    String expected = "ОднажЫы в \"студеЫую\" зимнюЫ: пору\nI went from a foresЫ, so-caЫled\n\n\n"
  ...
  public void correctCharacterTest() {
    ...
    String actual = textEditor.getText();
    String expected = "Однажды в \"студеную\" зимнюю: пору\nI went from a forЖst, so-called\n\n\n"
  ...
  public void clearTextFromPunctuationTest1() {
    ...
    String expected = "Однажды в студеную зимнюю пору I went from a forest so-called "
            + "DeepForest страшное место Кто-нибудь хотел бы там побывать";
    assertEquals(actual, expected);
  }
  ...
  public void clearTextFromPunctuationTest2() {
    ...
    TextEditor textEditor2 = new StringTextEditorImpl(textLoader2);
  ...
  public void testOnNull() {
    ...
    TextEditor textEditor3 = new StringTextEditorImpl(textLoader3);
  ...
  public void removeConsonantWords() {
    ...
    String actual = textEditor.getText().trim();
    String expected = "Однажды в \"студеную\" : пору\nI went from a , so-called\n\n\n"
            + "\"DeepForest!!!\" - страшное место... Кто-нибудь хотел; бы там побывать?";
    assertEquals(actual, expected);
  }
