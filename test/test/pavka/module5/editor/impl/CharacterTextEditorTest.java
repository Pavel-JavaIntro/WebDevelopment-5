...
import by.pavka.module5.editor.impl.CharacterTextEditorImpl;
...
public class CharacterTextEditorTest {
  private String text =
  ...
  private TextEditor textEditor = new CharacterTextEditorImpl(textLoader);
  ...
  public void clearTextFromPunctuationTest2() {
    ...
    TextEditor textEditor2 = new CharacterTextEditorImpl(textLoader2);
  ...
  public void testOnNull() {
    ...
    TextEditor textEditor3 = new CharacterTextEditorImpl(textLoader3);
